...
If you've connected Clairdash to GitHub, you can setup a `github action` and get Clairdash to deploy your project automatically. This is the easiest way to keep Clairdash in sync with your changes in dbt.
...
Now copy [this file](https://github.com/clairdash/cli-actions/blob/main/deploy.yml) from our [cli-actions](https://github.com/clairdash/cli-actions) repo.

Give it a nice name like `deploy-clairdash.yml`

And commit this to your repo by clicking on `Start commit`.

### You're done!

Everytime you make a change to your repo, on the `main` branch, it will automatically deploy your new config into your Clairdash projects
