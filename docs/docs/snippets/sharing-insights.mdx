...
In Clairdash there are three primary ways to share insights with your team:
...
As you explore your data in Clairdash, the URL contains a unique link to your work in progress.

Copy and paste the url while you're exploring data and anybody with access to your Clairdash project can jump into the Explore view at exactly the same point you're at.
...
You can also download your results table as a .CSV or export them to a Google Sheet, with just the click of a button. So, you can import data from Clairdash into other tools, or just save them on your computer for later 😉
