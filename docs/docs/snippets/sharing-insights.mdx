...
You can also download your results table as a .CSV or export them to a Google Sheet, with just the click of a button. So, you can import data from Bigbytes into other tools, or just save them on your computer for later 😉
