...
:::info
If you already have a GitHub action for Clairdash, then you can use the same Clairdash secrets you created for your other action.
:::
...
Create a new personal access token, by going to `Settings` > `Personal Access Tokens`. This is the token you'll put in for `CLAIRDASH_API_KEY`.
...
The UUID for your project. For example, if your URL looks like `https://eu1.clairdash.cloud/projects/3538ab33-dc90-aabb-bc00-e50bba3a5f69/tables`, then `3538ab33-dc90-45f0-aabb-e50bba3a5f69` is your `CLAIRDASH_PROJECT`

#### `CLAIRDASH_URL`

This is either `https://eu1.clairdash.cloud` or `https://app.clairdash.cloud` for Clairdash Cloud users (check the URL to your Clairdash project).
...
- If you want to have different connection settings depending on the user that opened the pull request (dev profiles), then [check out this guide](/guides/cli/how-to-use-clairdash-preview#how-to-use-the-developer-credentials-in-your-preview-project).
