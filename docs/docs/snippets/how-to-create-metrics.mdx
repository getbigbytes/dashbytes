...
You can [see the full list of metric types](/references/metrics.mdx#metric-types) that you can use in your Bigbytes project.

We support metrics defined using either Bigbytes or dbt syntax! You can read more about the two methods [in our reference docs here](/references/metrics.mdx#adding-metrics-to-your-project).
