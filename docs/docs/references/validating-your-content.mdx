...
Broken content is not useful content. We've built tools in Bigbytes to help validate your content so you can keep it useful and we'll notify you when it isn't.
...
- the command `bigbytes deploy` is run on the [Bigbytes CLI](/guides/cli/intro) (you can read more about automatically deploying your changes using GitHub actions [here](https://docs.bigbytes.com/guides/cli/how-to-use-bigbytes-deploy#automatically-deploy-your-changes-to-bigbytes-using-a-github-action))
