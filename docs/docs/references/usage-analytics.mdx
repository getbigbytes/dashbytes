...
To understand who is accessing content or running queries in your Clairdash projects, we've built usage analytics to help you track this. There are two ways of understanding user activity:

1. **[Usage Analytics dashboards](#usage-analytics-dashboards)** - these are dashboards created by Clairdash which give you an overview of your project's content and user activity.
...
Each project has usage analytics dashboards created by Clairdash giving you an overview of your project's content and user activity.
...
Or you can also use our [search bar](https://docs.clairdash.com/get-sarted/exploring-data/exploring-your-content#using-the-search-bar) to get direct access to
