...
To understand who is accessing content or running queries in your Bigbytes projects, we've built usage analytics to help you track this. There are two ways of understanding user activity:
...
Or you can also use our [search bar](https://docs.bigbytes.com/get-sarted/exploring-data/exploring-your-content#using-the-search-bar) to get direct access to
