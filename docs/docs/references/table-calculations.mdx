...
| Format types | Description                                     | Raw value | How it might look like in Clairdash |
| ------------ | ----------------------------------------------- | --------- | ----------------------------------- |
