...
The dbt Semantic Layer integration is only available to [Bigbytes Cloud users](https://www.bigbytes.com/pricing). To have the dbt Semantic Layer integration activated on your account, please message support@digi-trans.org.
