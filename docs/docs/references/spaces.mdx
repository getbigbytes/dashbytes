...
Once you've used Clairdash for a while, your team will probably end up with a lot of saved charts and dashboards. Spaces let you organize your saved charts and dashboards.
...
To access Spaces, you can either select a Space from the drop-down list in `Browse` or you can click on the Clairdash icon and select your Space from the homepage.
...
For example, here I have a Space with Restricted Access. Only admins and the invited members have access to this Space. Katie, Filipe and Marshall have inherited `Full Access` because they are organization admins. Priyanka was invited to the space, so she has `Can View` access to the space. No one else in Clairdash can see or interact with the content in this Space unless they're invited or become an admin.
...
For example, here I have a Space with Public access. Everyone who has access to my Project, "Clairdash analytics", will get access to the content in my public space.
