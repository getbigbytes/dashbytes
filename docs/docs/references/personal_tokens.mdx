...
You can create a personal access token (PAT) to authenticate in the [CLI](../get-started/setup-bigbytes/get-project-bigbytes-ready.mdx) or
with the API.
...
```
curl --location --request PATCH 'https://my.bigbytes.com/api/v1/user/me/personal-access-tokens/<personal-access-token-uuid>/rotate' \
