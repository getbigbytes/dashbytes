...
You can create a personal access token (PAT) to authenticate in the [CLI](../get-started/setup-clairdash/get-project-clairdash-ready.mdx) or
with the API.
...
```
curl --location --request PATCH 'https://my.clairdash.com/api/v1/user/me/personal-access-tokens/<personal-access-token-uuid>/rotate' \
