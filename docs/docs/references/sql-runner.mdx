...
1. A list of tables in your data warehouse that Clairdash has access to (based on your data warehouse connection in Clairdash).
...
2. [Create a **Virtual View** so your query becomes a reusable table in Clairdash](/references/virtual-views)
