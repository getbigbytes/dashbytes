...
Joins let you connect different models to each other so that you can explore more than one model at the same time in Bigbytes and see how different parts of your data relate to each other.
