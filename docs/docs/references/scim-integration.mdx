...
import ScimBigbytesGenerateToken from './assets/scim/scim-bigbytes-generate-token.png';
import ScimBigbytesGeneratedToken from './assets/scim/scim-bigbytes-generated-token.png';
import ScimBigbytesTokensList from './assets/scim/scim-bigbytes-tokens-list.png';
import ScimBigbytesUserSettings from './assets/scim/scim-bigbytes-user-settings.png';
import ScimBigbytesViewURL from './assets/scim/scim-bigbytes-view-url.png';
...
SCIM Integration is only available on Bigbytes Enterprise plans. For more information on our plans, visit our [pricing page](https://www.bigbytes.com/pricing).
...
4. Once generated, copy and save it in a safe place, as it cannot be viewed again once the modal is closed.
   ...
   <img
     src={ScimBigbytesGeneratedToken}
     width="670"
     height="266"
     style={{ display: 'block', margin: '0 auto 20px auto' }}
   />
...
```
curl --location --request PATCH 'https://my.bigbytes.com/api/v1/scim/organization-access-tokens/<personal-access-token-uuid>/rotate' \
