...
Check out [this doc](https://docs.bigbytes.com/references/metrics#metric-configuration) to see all of the other properties you can customize for metrics.

### Changing the name of your fields in Bigbytes
...
Check out [this doc](https://docs.bigbytes.com/references/dimensions#dimension-configuration) to see all of the other properties you can customize for dimensions, and [this one](https://docs.bigbytes.com/references/metrics#metric-configuration) for all of the other properties you can customize for your metrics.
...
Check out [this doc](https://docs.bigbytes.com/references/dimensions#dimension-configuration) to see all of the other properties you can customize for dimensions.
...
Check out [this doc](https://docs.bigbytes.com/references/dimensions#compact-values) to see all the other compact values.
...
Check out [this doc](https://docs.bigbytes.com/references/metrics#compact-values) to see all the other compact values.
...
You can see which format types are currently available for [dimensions](https://docs.bigbytes.com/references/dimensions#:~:text=number%20of%20digits-,format,-No), and for [metrics.](https://docs.bigbytes.com/references/metrics#:~:text=number%20of%20digits-,format,-No)
...
To see which format types are available for dimensions, [check the reference docs here.](https://docs.bigbytes.com/references/dimensions#:~:text=number%20of%20digits-,format,-No). Check out [this doc](https://docs.bigbytes.com/references/dimensions#dimension-configuration) to see all of the other properties you can customize for dimensions.
...
## Formatting your fields in the Bigbytes UI
