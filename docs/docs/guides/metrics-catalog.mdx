...
You have to have permissions to make changes to your Clairdash .yml files so you can set a default time dimension on a table level. This will be used to prefill the time dimension in the explore view.

### 2. Set a default time dimension on a table level in your Clairdash .yml file
