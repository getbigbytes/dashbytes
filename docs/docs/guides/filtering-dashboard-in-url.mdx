...
5. Paste that URL into the YAML file for the model you're working in. See an [example in our demo project here](https://github.com/getbigbytes/bigbytes-demo-data-gardening/blob/5632406cb5b43fdf066a2086142dc3e86a41e947/dbt/models/dbt_orders.yml#L31-L32).
