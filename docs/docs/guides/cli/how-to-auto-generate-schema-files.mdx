# Autogenerate Bigbytes-ready .yml files for your models

The beauty of Bigbytes is that we're pretty well synced with your dbt project. So, in Bigbytes, Tables actually come from dbt models that have been defined in your dbt project's `.yml` files.
...
To make it faster to write and maintain your `schema.yml` files, the Bigbytes CLI will automatically generate and
...
### The Bigbytes CLI will automatically add doc blocks to your .yml files
