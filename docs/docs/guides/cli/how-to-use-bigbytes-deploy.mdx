...
# Sync your changes with Bigbytes deploy

## `bigbytes deploy` syncs the changes in your dbt project to Bigbytes
...
## Automatically deploy your changes to Bigbytes using a GitHub action
