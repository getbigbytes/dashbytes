...
ENV BIGBYTES_SECRET="not very secret"
ENV RUDDERSTACK_WRITE_KEY=1vikeGadtB0Y0oRDFNL2Prdhkbp
ENV RUDDERSTACK_DATA_PLANE_URL=https://analytics.bigbytes.com
ENV DBT_DEMO_DIR=/workspace/bigbytes/examples/full-jaffle-shop-demo
ENV NODE_ENV=development
ENV BIGBYTES_LOG_LEVEL=debug
