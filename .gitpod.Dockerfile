...
ENV CLAIRDASH_SECRET="not very secret"
ENV RUDDERSTACK_WRITE_KEY=1vikeGadtB0Y0oRDFNL2Prdhkbp
ENV RUDDERSTACK_DATA_PLANE_URL=https://analytics.clairdash.com
ENV DBT_DEMO_DIR=/workspace/clairdash/examples/full-jaffle-shop-demo
ENV NODE_ENV=development
ENV CLAIRDASH_LOG_LEVEL=debug
