import { ClairdashMode, OrganizationMemberRole } from '@clairdash/common';
import { ClairdashConfig } from './parseConfig';

export const clairdashConfigMock: ClairdashConfig = {
    ...
    clairdashCloudInstance: 'test-instance',
    k8s: {
    ...
    github: {
        appName: 'clairdash-app-dev',
        redirectDomain: 'test',
    },
    headlessBrowser: {
        internalClairdashHost: 'https://test.clairdash.cloud',
    },
};
