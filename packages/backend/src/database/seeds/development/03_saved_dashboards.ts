...
const markdownSample = `### Clairdash is an analytics platform for your dbt project.

#### At Clairdash, our mission is simple:
...
async function createDashboardWithAllTileTypes(knex: Knex): Promise<void> {
    ...
    const loomTile: CreateDashboardLoomTile = {
        ...
        properties: {
            ...
            url: 'https://www.loom.com/share/5ccc644fa8bf68ffb7b783',
        },
    };
