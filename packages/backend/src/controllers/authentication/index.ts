...
// 2. passport.GoogleStrategy redirects the browser to Google where the user signs in to google and agrees to pass info to Bigbytes
// 3. Google redirects the user to /oauth/google/callback with a secret token to show Bigbytes that the user authenticated
