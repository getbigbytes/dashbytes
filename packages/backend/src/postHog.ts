import { FeatureFlags, SessionUser } from '@clairdash/common';
...
export const postHogClient = clairdashConfig.posthog
    ? new PostHog(clairdashConfig.posthog.projectApiKey, {
          host: clairdashConfig.posthog.beApiHost,
      })
    : undefined;
