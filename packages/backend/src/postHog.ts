import { FeatureFlags, SessionUser } from '@bigbytes/common';
...
export const postHogClient = bigbytesConfig.posthog
    ? new PostHog(bigbytesConfig.posthog.projectApiKey, {
          host: bigbytesConfig.posthog.beApiHost,
      })
    : undefined;
