...
export class S3CacheClient {
    configuration: BigbytesConfig['resultsCache']['s3'];

    private readonly s3?: S3;

    constructor({ bigbytesConfig }: S3CacheClientArguments) {
        const endpoint = bigbytesConfig.s3?.endpoint;
        this.configuration = bigbytesConfig.resultsCache.s3;
