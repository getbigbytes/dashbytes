...
export class S3CacheClient {
    configuration: ClairdashConfig['resultsCache']['s3'];

    private readonly s3?: S3;

    constructor({ clairdashConfig }: S3CacheClientArguments) {
        const endpoint = clairdashConfig.s3?.endpoint;
        this.configuration = clairdashConfig.resultsCache.s3;
