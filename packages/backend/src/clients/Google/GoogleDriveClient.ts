...
export class GoogleDriveClient {
    ...
    constructor({ clairdashConfig }: GoogleDriveClientArguments) {
        this.clairdashConfig = clairdashConfig;
        this.isEnabled =
            clairdashConfig.auth.google.oauth2ClientId !== undefined &&
            clairdashConfig.auth.google.oauth2ClientSecret !== undefined;
    }
    ...
    private async getCredentials(refreshToken: string) {
        try {
            const credentials = {
                ...
                client_id: this.clairdashConfig.auth.google.oauth2ClientId,
                client_secret:
                    this.clairdashConfig.auth.google.oauth2ClientSecret,
    ...
    async uploadMetadata(
        ...
        const metadata: string[][] = [
            [
                'The data in this Google Sheet has been automatically synced via Clairdash',
            ],
