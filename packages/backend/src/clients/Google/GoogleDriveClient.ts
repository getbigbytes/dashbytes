...
export class GoogleDriveClient {
    ...
    constructor({ bigbytesConfig }: GoogleDriveClientArguments) {
        this.bigbytesConfig = bigbytesConfig;
        this.isEnabled =
            bigbytesConfig.auth.google.oauth2ClientId !== undefined &&
            bigbytesConfig.auth.google.oauth2ClientSecret !== undefined;
    }
    ...
    private async getCredentials(refreshToken: string) {
        try {
            const credentials = {
                ...
                client_id: this.bigbytesConfig.auth.google.oauth2ClientId,
                client_secret:
                    this.bigbytesConfig.auth.google.oauth2ClientSecret,
    ...
    async uploadMetadata(
        ...
        const metadata: string[][] = [
            [
                'The data in this Google Sheet has been automatically synced via Bigbytes',
            ],
