...
export class SchedulerWorker extends SchedulerTask {
    ...
    async run() {
        ...
        this.runner = await runGraphileWorker({
            connectionString: this.clairdashConfig.database.connectionUri,
            logger: workerLogger,
            concurrency: this.clairdashConfig.scheduler?.concurrency,
        ...
        return {
            ...
            handleScheduledDelivery: async (
                ...
                await tryJobOrTimeout(
                    ...
                    helpers.job,
                    this.clairdashConfig.scheduler.jobTimeout,
                    async (job, e) => {
