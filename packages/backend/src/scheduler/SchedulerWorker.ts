...
export class SchedulerWorker extends SchedulerTask {
    ...
    async run() {
        ...
        this.runner = await runGraphileWorker({
            connectionString: this.bigbytesConfig.database.connectionUri,
            logger: workerLogger,
            concurrency: this.bigbytesConfig.scheduler?.concurrency,
        ...
        return {
            ...
            handleScheduledDelivery: async (
                ...
                await tryJobOrTimeout(
                    ...
                    helpers.job,
                    this.bigbytesConfig.scheduler.jobTimeout,
                    async (job, e) => {
