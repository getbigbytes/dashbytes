...
export const CLAIRDASH_PROFILE_NAME = 'clairdash_profile';
export const CLAIRDASH_TARGET_NAME = 'prod';
const DEFAULT_THREADS = 1;

const envVar = (v: string) => `CLAIRDASH_DBT_PROFILE_VAR_${v.toUpperCase()}`;
            ...
            return {
                target: {
                    ...
                    sslrootcert: require.resolve(
                        '@clairdash/warehouses/dist/warehouseClients/ca-bundle-aws-redshift.crt',
                    ),
            ...
            return {
                target: {
                    ...
                    ...(credentials.host.endsWith('.rds.amazonaws.com')
                        ? {
                              sslrootcert: require.resolve(
                                  '@clairdash/warehouses/dist/warehouseClients/ca-bundle-aws-rds-global.pem',
                              ),
                          }
                        : {}),
                },
...
export const profileFromCredentials = (
    ...
    const targetName = customTargetName || CLAIRDASH_TARGET_NAME;
