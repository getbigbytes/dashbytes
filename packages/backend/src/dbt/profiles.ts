...
export const BIGBYTES_PROFILE_NAME = 'bigbytes_profile';
export const BIGBYTES_TARGET_NAME = 'prod';
const DEFAULT_THREADS = 1;

const envVar = (v: string) => `BIGBYTES_DBT_PROFILE_VAR_${v.toUpperCase()}`;
            ...
            return {
                target: {
                    ...
                    sslrootcert: require.resolve(
                        '@bigbytes/warehouses/dist/warehouseClients/ca-bundle-aws-redshift.crt',
                    ),
            ...
            return {
                target: {
                    ...
                    ...(credentials.host.endsWith('.rds.amazonaws.com')
                        ? {
                              sslrootcert: require.resolve(
                                  '@bigbytes/warehouses/dist/warehouseClients/ca-bundle-aws-rds-global.pem',
                              ),
                          }
                        : {}),
                },
...
export const profileFromCredentials = (
    ...
    const targetName = customTargetName || BIGBYTES_TARGET_NAME;
