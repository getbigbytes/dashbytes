...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    'Pick_ClairdashUser.userUuid-or-firstName-or-lastName_': {
        dataType: 'refAlias',
        type: {
            dataType: 'nestedObjectLiteral',
            nestedProperties: {
        ...
        type: {
            ...
            nestedProperties: {
                createdBy: {
                    ...
                    subSchemas: [
                        {
                            ref: 'Pick_ClairdashUser.userUuid-or-firstName-or-lastName_',
                        },
                        { dataType: 'enum', enums: [null] },
                    ],
                    required: true,
    ...
    ApiGetAuthenticatedUserResponse: {
        ...
        type: {
            dataType: 'nestedObjectLiteral',
            nestedProperties: {
                results: { ref: 'ClairdashUser', required: true },
                status: { dataType: 'enum', enums: ['ok'], required: true },
            },
            validators: {},
        },
    ...
    app.patch(
        ...
        async function CatalogController_updateCatalogItemIcon(
            ...
            try {
                ...
                const promise = controller.updateCatalogItemIcon.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.patch(
        ...
        async function ProjectController_updateTag(
            ...
            try {
                ...
                const promise = controller.updateTag.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
    ...
    app.get(
        ...
        async function ProjectController_getChartsAsCode(
            ...
            try {
                ...
                const promise = controller.getChartsAsCode.apply(
                    controller,
                    validatedArgs as any,
                );
                promiseHandler(controller, promise, response, 200, next);
