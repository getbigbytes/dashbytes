...
export class OperationContext extends BaseService {
    ...
    public readonly bigbytesAnalytics: BigbytesAnalytics;

    public readonly bigbytesConfig: BigbytesConfig;
    ...
    constructor({
        ...
        operationId: string;
        bigbytesAnalytics: BigbytesAnalytics;
        bigbytesConfig: BigbytesConfig;
    }) {
        super();
        this.operationId = operationId;
        this.bigbytesAnalytics = bigbytesAnalytics;
    ...
    implements ServiceFactoryMethod<ServiceManifest>
{
        ...
        return this.getService(
            ...
            () =>
                new AnalyticsService({
                    analytics: this.context.bigbytesAnalytics,
    ...
    public getCsvService(): CsvService {
        return this.getService(
            ...
            () =>
                new CsvService({
                    bigbytesConfig: this.context.bigbytesConfig,
                    analytics: this.context.bigbytesAnalytics,
