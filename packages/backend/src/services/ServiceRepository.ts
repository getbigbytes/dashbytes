...
export class OperationContext extends BaseService {
    ...
    public readonly clairdashAnalytics: ClairdashAnalytics;

    public readonly clairdashConfig: ClairdashConfig;
    ...
    constructor({
        ...
        operationId: string;
        clairdashAnalytics: ClairdashAnalytics;
        clairdashConfig: ClairdashConfig;
    }) {
        super();
        this.operationId = operationId;
        this.clairdashAnalytics = clairdashAnalytics;
    ...
    implements ServiceFactoryMethod<ServiceManifest>
{
        ...
        return this.getService(
            ...
            () =>
                new AnalyticsService({
                    analytics: this.context.clairdashAnalytics,
    ...
    public getCsvService(): CsvService {
        return this.getService(
            ...
            () =>
                new CsvService({
                    clairdashConfig: this.context.clairdashConfig,
                    analytics: this.context.clairdashAnalytics,
