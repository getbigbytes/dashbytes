import { InviteLink, NotExistsError } from '@bigbytes/common';
...
export class InviteLinkModel {
    ...
    constructor({ database, bigbytesConfig }: InviteLinkModelArguments) {
    ...
    private transformInviteCodeToUrl(code: string): string {
        return new URL(`/invite/${code}`, this.bigbytesConfig.siteUrl).href;
    }
