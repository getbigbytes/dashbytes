import { InviteLink, NotExistsError } from '@clairdash/common';
...
export class InviteLinkModel {
    ...
    constructor({ database, clairdashConfig }: InviteLinkModelArguments) {
    ...
    private transformInviteCodeToUrl(code: string): string {
        return new URL(`/invite/${code}`, this.clairdashConfig.siteUrl).href;
    }
