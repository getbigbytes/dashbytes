import { NotExistsError, PasswordResetLink } from '@clairdash/common';
...
export class PasswordResetLinkModel {
    ...
    private clairdashConfig: ClairdashConfig;
    ...
    transformCodeToUrl(code: string): string {
        return new URL(`/reset-password/${code}`, this.clairdashConfig.siteUrl)
            .href;
    }
