import { NotExistsError, PasswordResetLink } from '@bigbytes/common';
...
export class PasswordResetLinkModel {
    ...
    private bigbytesConfig: BigbytesConfig;
    ...
    transformCodeToUrl(code: string): string {
        return new URL(`/reset-password/${code}`, this.bigbytesConfig.siteUrl)
            .href;
    }
