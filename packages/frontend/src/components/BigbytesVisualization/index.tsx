import { assertUnreachable, ChartType } from '@bigbytes/common';
...
interface BigbytesVisualizationProps {
    isDashboard?: boolean;
    tileUuid?: string;
...
const BigbytesVisualization: FC<BigbytesVisualizationProps> = memo(
    ({
        isDashboard = false,
        tileUuid,
        isTitleHidden = false,
...
export default BigbytesVisualization;
