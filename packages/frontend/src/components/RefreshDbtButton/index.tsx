import { DbtProjectType, JobStatusType, ProjectType } from '@clairdash/common';
import {
    Anchor,
    Badge,
    Box,
...
const RefreshDbtButton: FC<{
            ...
            <Popover withinPortal withArrow width={300}>
                ...
                <Popover.Dropdown>
                    <Text>
                        ...
                        CLI.
                        <br />
                        To keep your Clairdash project in sync with your dbt
                        project,
    ...
    if (data?.type === ProjectType.PREVIEW) {
        return (
            <Tooltip
                withinPortal
                label={`Developer previews are temporary Clairdash projects`}
            >
    ...
    return (
        <Tooltip
            ...
            w={320}
            position="bottom"
            label="If you've updated your YAML files, you can sync your changes to Clairdash by clicking this button."
        >
            <Button
                size="xs"
                variant="default"
