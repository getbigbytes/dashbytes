import { assertUnreachable, ChartType } from '@clairdash/common';
...
interface ClairdashVisualizationProps {
    isDashboard?: boolean;
    tileUuid?: string;
...
const ClairdashVisualization: FC<ClairdashVisualizationProps> = memo(
    ({
        isDashboard = false,
        tileUuid,
        isTitleHidden = false,
...
export default ClairdashVisualization;
