            ...
            <Stack>
                <Stack spacing="sm">
                    ...
                    <Text color="dimmed" fz="xs">
                        Sharing in Slack allows you to unfurl Bigbytes URLs and
                        schedule deliveries to specific people or channels
                        within your Slack workspace.{' '}
                        <Anchor href="https://docs.bigbytes.com/references/slack-integration">
                            View docs
                        </Anchor>
                    </Text>
                </Stack>
                        ...
                        <Stack spacing="sm">
                            ...
                            <Group spacing="xl">
                                ...
                                <TextInput
                                    ...
                                    size="xs"
                                    placeholder="https://bigbytes.cloud/photo.jpg"
                                    type="url"
