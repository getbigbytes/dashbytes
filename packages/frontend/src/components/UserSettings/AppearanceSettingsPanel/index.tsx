...
import { ECHARTS_DEFAULT_COLORS } from '@bigbytes/common';
import {
    ActionIcon,
    Button,
    Card,
        ...
        <Stack spacing="sm">
            <Group spacing="xxs">
                ...
                >
                    <ActionIcon
                        component="a"
                        href="https://docs.bigbytes.com/guides/customizing-the-appearance-of-your-project"
                        target="_blank"
                        rel="noreferrer"
                    >
