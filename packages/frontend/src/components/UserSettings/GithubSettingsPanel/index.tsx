import { type ApiError, type GitRepo } from '@bigbytes/common';
import {
    Alert,
    Avatar,
    Box,
        ...
        <SettingsGridCard>
            ...
            <Stack>
                <Text color="dimmed" fz="xs">
                    Installing GitHub App allows Bigbytes to access your GitHub
                    ...
                    <Flex justify="end">
                        {isWaitingForGithubRequest ? (
                            <Tooltip
                                ...
                                installation. They should have received an email for a "Request to install bigbytes" from GitHub.`}
                            >
                                <Button
                                    size="xs"
                                    component="a"
