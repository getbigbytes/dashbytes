import { type ApiError, type GitRepo } from '@clairdash/common';
import {
    Alert,
    Avatar,
    Box,
        ...
        <SettingsGridCard>
            ...
            <Stack>
                <Text color="dimmed" fz="xs">
                    Installing GitHub App allows Clairdash to access your GitHub
                    ...
                    <Flex justify="end">
                        {isWaitingForGithubRequest ? (
                            <Tooltip
                                ...
                                installation. They should have received an email for a "Request to install clairdash" from GitHub.`}
                            >
                                <Button
                                    size="xs"
                                    component="a"
