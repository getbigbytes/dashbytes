                ...
                <div>
                    ...
                    <Flex align="center" gap={2}>
                        ...
                        <DocumentationHelpButton
                            href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#warehouse-connection"
                            pos="relative"
                            top="2px"
                        />
                    </Flex>
            ...
            <SettingsGridCard>
                <div>
                    ...
                    <Flex align="center" gap={2}>
                        ...
                        <DocumentationHelpButton
                            href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project"
                            pos="relative"
                            top="2px"
                        />
                    </Flex>
    ...
    if (data?.type === ProjectType.PREVIEW) {
        return (
            <Alert
                ...
                title="Developer previews are temporary Clairdash projects where settings cannot be changed."
            >
                Read docs{' '}
                <Anchor
                    href="https://docs.clairdash.com/guides/cli/how-to-use-clairdash-preview"
                    target="_blank"
                    rel="noreferrer"
                >
                    here
