                ...
                <div>
                    ...
                    <Flex align="center" gap={2}>
                        ...
                        <DocumentationHelpButton
                            href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#warehouse-connection"
                            pos="relative"
                            top="2px"
                        />
                    </Flex>
            ...
            <SettingsGridCard>
                <div>
                    ...
                    <Flex align="center" gap={2}>
                        ...
                        <DocumentationHelpButton
                            href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project"
                            pos="relative"
                            top="2px"
                        />
                    </Flex>
    ...
    if (data?.type === ProjectType.PREVIEW) {
        return (
            <Alert
                ...
                title="Developer previews are temporary Bigbytes projects where settings cannot be changed."
            >
                Read docs{' '}
                <Anchor
                    href="https://docs.bigbytes.com/guides/cli/how-to-use-bigbytes-preview"
                    target="_blank"
                    rel="noreferrer"
                >
                    here
