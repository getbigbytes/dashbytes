import { DbtProjectType } from '@clairdash/common';
                ...
                <PasswordInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#github"
                                rel="noreferrer"
                            >
                                {' '}
                ...
                <TextInput
                    ...
                    description={
                        <p>
                            ...
                            e.g. <b>clairview/clairdash-analytics</b>
                        </p>
                    }
                    required
                    ...
                    description={
                        <>
                            <p>
                                ...
                                Clairdash should sync to. e.g. <b>main</b>,{' '}
                    ...
                    description={
                        <>
                            <p>
                                ...
                                clairview/clairdash-analytics/dbt_project.yml).
                            </p>
                            <p>
                                ...
                                project was in
                                clairview/clairdash-analytics/dbt/dbt_project.yml,
