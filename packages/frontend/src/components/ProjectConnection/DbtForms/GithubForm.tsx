import { DbtProjectType } from '@bigbytes/common';
                ...
                <PasswordInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#github"
                                rel="noreferrer"
                            >
                                {' '}
                ...
                <TextInput
                    ...
                    description={
                        <p>
                            ...
                            e.g. <b>getbigbytes/bigbytes-analytics</b>
                        </p>
                    }
                    required
                    ...
                    description={
                        <>
                            <p>
                                ...
                                Bigbytes should sync to. e.g. <b>main</b>,{' '}
                    ...
                    description={
                        <>
                            <p>
                                ...
                                getbigbytes/bigbytes-analytics/dbt_project.yml).
                            </p>
                            <p>
                                ...
                                project was in
                                getbigbytes/bigbytes-analytics/dbt/dbt_project.yml,
