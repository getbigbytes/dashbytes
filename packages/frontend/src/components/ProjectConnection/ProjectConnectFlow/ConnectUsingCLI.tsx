...
const ConnectUsingCLI: FC<ConnectUsingCliProps> = ({
    ...
    useEffect(() => {
        ...
        mutateAccessToken({
            expiresAt,
            description: `Generated by the Clairdash UI for CLI at ${generatedAtString}`,
            autoGenerated: true,
        });
        ...
        <OnboardingWrapper>
            ...
            <ProjectCreationCard>
                ...
                <Stack spacing="xl">
                    ...
                    <Stack ta="left">
                        <Stack spacing="xs">
                            <Text fw={500}>1. Install clairdash CLI:</Text>
                            ...
                            <Prism
                                ...
                                styles={{ copy: { right: 0 } }}
                            >
                                {`npm install -g @clairdash/cli@${version}`}
                            </Prism>
                        </Stack>

                        <Stack spacing="xs">
                            <Text fw={500}>2. Login to clairdash:</Text>
                            ...
                            <Prism
                                ...
                                styles={{ copy: { right: 0 } }}
                            >
                                {`clairdash login ${siteUrl} --token ${tokenData?.token}`}
                            </Prism>
                        </Stack>
