...
const ConnectUsingCLI: FC<ConnectUsingCliProps> = ({
    ...
    useEffect(() => {
        ...
        mutateAccessToken({
            expiresAt,
            description: `Generated by the Bigbytes UI for CLI at ${generatedAtString}`,
            autoGenerated: true,
        });
        ...
        <OnboardingWrapper>
            ...
            <ProjectCreationCard>
                ...
                <Stack spacing="xl">
                    ...
                    <Stack ta="left">
                        <Stack spacing="xs">
                            <Text fw={500}>1. Install bigbytes CLI:</Text>
                            ...
                            <Prism
                                ...
                                styles={{ copy: { right: 0 } }}
                            >
                                {`npm install -g @bigbytes/cli@${version}`}
                            </Prism>
                        </Stack>

                        <Stack spacing="xs">
                            <Text fw={500}>2. Login to bigbytes:</Text>
                            ...
                            <Prism
                                ...
                                styles={{ copy: { right: 0 } }}
                            >
                                {`bigbytes login ${siteUrl} --token ${tokenData?.token}`}
                            </Prism>
                        </Stack>
