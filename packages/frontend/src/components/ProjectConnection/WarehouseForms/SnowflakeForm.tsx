import { FeatureFlags, WarehouseTypes } from '@bigbytes/common';
import {
    Anchor,
    Group,
    PasswordInput,
        ...
        <>
            <Stack style={{ marginTop: '8px' }}>
                ...
                <BooleanSwitch
                    ...
                    documentationUrl="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#warehouse"
                ...
                <FormSection isOpen={isOpen} name="advanced">
                    <Stack style={{ marginTop: '8px' }}>
                        ...
                        <TextInput
                            ...
                            description={
                                <p>
                                    Usually Bigbytes would connect to a default
