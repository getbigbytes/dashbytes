import { FeatureFlags, WarehouseTypes } from '@clairdash/common';
import {
    Anchor,
    Group,
    PasswordInput,
        ...
        <>
            <Stack style={{ marginTop: '8px' }}>
                ...
                <BooleanSwitch
                    ...
                    documentationUrl="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#warehouse"
                ...
                <FormSection isOpen={isOpen} name="advanced">
                    <Stack style={{ marginTop: '8px' }}>
                        ...
                        <TextInput
                            ...
                            description={
                                <p>
                                    Usually Clairdash would connect to a default
