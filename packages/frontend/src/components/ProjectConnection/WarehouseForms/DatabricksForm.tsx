import { WarehouseTypes } from '@clairdash/common';
        ...
        <TextInput
            ...
            description={
                <p>
                    ...
                    <Anchor
                        target="_blank"
                        href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project/#database-1"
                        rel="noreferrer"
                    >
                        given documentation
                    </Anchor>
                ...
                <TextInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#server-hostname"
                                rel="noreferrer"
                            >
                                given documentation
                            </Anchor>
                ...
                <TextInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#http-path"
                                rel="noreferrer"
                            >
                                given documentation
                            </Anchor>
                ...
                <PasswordInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#personal-access-token"
                                rel="noreferrer"
                            >
                                given documentation
                            </Anchor>
