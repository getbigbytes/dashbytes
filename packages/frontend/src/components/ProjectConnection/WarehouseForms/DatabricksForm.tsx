import { WarehouseTypes } from '@bigbytes/common';
        ...
        <TextInput
            ...
            description={
                <p>
                    ...
                    <Anchor
                        target="_blank"
                        href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project/#database-1"
                        rel="noreferrer"
                    >
                        given documentation
                    </Anchor>
                ...
                <TextInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#server-hostname"
                                rel="noreferrer"
                            >
                                given documentation
                            </Anchor>
                ...
                <TextInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#http-path"
                                rel="noreferrer"
                            >
                                given documentation
                            </Anchor>
                ...
                <PasswordInput
                    ...
                    description={
                        <p>
                            ...
                            <Anchor
                                target="_blank"
                                href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#personal-access-token"
                                rel="noreferrer"
                            >
                                given documentation
                            </Anchor>
