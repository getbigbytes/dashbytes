...
export const BigQuerySchemaInput: FC<{
    ...
    return (
        <Input
            ...
            documentationUrl="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#data-set"
            rules={{
                        ...
                        <FileInput
                            ...
                            description={
                                <p>
                                    ...
                                    <Anchor
                                        target="_blank"
                                        href="https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project#key-file"
                                        rel="noreferrer"
                                    >
