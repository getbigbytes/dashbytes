...
export const BigQuerySchemaInput: FC<{
    ...
    return (
        <Input
            ...
            documentationUrl="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#data-set"
            rules={{
                        ...
                        <FileInput
                            ...
                            description={
                                <p>
                                    ...
                                    <Anchor
                                        target="_blank"
                                        href="https://docs.clairdash.com/get-started/setup-clairdash/connect-project#key-file"
                                        rel="noreferrer"
                                    >
