...
import { hasIntersection, TableSelectionType } from '@clairdash/common';
import {
    Anchor,
    Box,
    Button,
                    ...
                    >
                        <Stack mt={'md'} spacing={'md'}>
                            <Radio
                                ...
                                description="Show all of the models in your dbt project in Clairdash."
                                disabled={disabled}
                            />
                            ...
                            <Box>
                                ...
                                {form.values.type ===
                                    ...
                                    <MultiSelect
                                        ...
                                        placeholder="e.g clairdash, prod"
                                        searchable
