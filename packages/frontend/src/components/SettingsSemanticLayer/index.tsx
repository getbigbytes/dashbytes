import { assertUnreachable, SemanticLayerType } from '@clairdash/common';
import {
    Anchor,
    Avatar,
    Group,
        ...
        <SettingsGridCard>
            <Stack spacing="sm">
                ...
                <Text color="dimmed">
                    ...
                    and report on your metric definitions in Clairdash.
                </Text>

                <Anchor
                    href="https://docs.clairdash.com/references/dbt-semantic-layer"
                    target="_blank"
                >
                    Learn more
                </Anchor>
