import { assertUnreachable, SemanticLayerType } from '@bigbytes/common';
import {
    Anchor,
    Avatar,
    Group,
        ...
        <SettingsGridCard>
            <Stack spacing="sm">
                ...
                <Text color="dimmed">
                    ...
                    and report on your metric definitions in Bigbytes.
                </Text>

                <Anchor
                    href="https://docs.bigbytes.com/references/dbt-semantic-layer"
                    target="_blank"
                >
                    Learn more
                </Anchor>
