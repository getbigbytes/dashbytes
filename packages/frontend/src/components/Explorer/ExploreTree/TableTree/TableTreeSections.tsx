        ...
        <>
                ...
                <Group position="apart" mt="sm" mb="xs" pr="sm">
                    ...
                    {hasMetrics ? null : (
                        <DocumentationHelpButton
                            href="https://docs.clairdash.com/guides/how-to-create-metrics"
                            tooltipProps={{
                                label: (
                                    <>
            ...
            !(
                ...
                <Group position="apart" mt="sm" mb="xs" pr="sm">
                    ...
                    <DocumentationHelpButton
                        href="https://docs.clairdash.com/guides/how-to-create-metrics#-adding-custom-metrics-in-the-explore-view"
                        tooltipProps={{
                            label: (
                                <>
