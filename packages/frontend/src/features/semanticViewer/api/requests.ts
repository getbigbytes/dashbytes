...
export const apiGetSemanticLayerInfo = ({
    ...
    clairdashApi<ApiSemanticLayerClientInfo['results']>({
        version: 'v2',
        method: 'GET',
...
export const apiGetSemanticLayerViews = ({
    ...
    clairdashApi<SemanticLayerView[]>({
        version: 'v2',
        method: 'GET',
...
export const apiPostSemanticLayerViewFields = ({
    ...
    return clairdashApi<SemanticLayerField[]>({
        version: 'v2',
        method: 'POST',
...
const apiPostSemanticLayerRun = ({
    ...
    clairdashApi<ApiJobScheduledResponse['results']>({
        version: 'v2',
        method: 'POST',
...
export const apiPostSemanticViewerChartCreate = ({
    ...
    clairdashApi<ApiSemanticViewerChartCreate['results']>({
        version: 'v2',
...
export const apiGetSavedSemanticViewerChart = async ({
    ...
    return clairdashApi<SavedSemanticViewerChart>({
        version: 'v2',
...
export const apiGetSavedSemanticViewerChartResults = async ({
    ...
    const scheduledJob = await clairdashApi<ApiJobScheduledResponse['results']>(
        {
            version: 'v2',
...
export const apiPatchSavedSemanticViewerChart = ({
    ...
    clairdashApi<ApiSemanticViewerChartUpdate['results']>({
        version: 'v2',
