...
export const apiGetSemanticLayerInfo = ({
    ...
    bigbytesApi<ApiSemanticLayerClientInfo['results']>({
        version: 'v2',
        method: 'GET',
...
export const apiPostSemanticLayerViewFields = ({
    ...
    return bigbytesApi<SemanticLayerField[]>({
        version: 'v2',
        method: 'POST',
...
export const apiPostSemanticViewerChartCreate = ({
    ...
    bigbytesApi<ApiSemanticViewerChartCreate['results']>({
        version: 'v2',
...
export const apiGetSavedSemanticViewerChart = async ({
    ...
    return bigbytesApi<SavedSemanticViewerChart>({
        version: 'v2',
...
export const apiGetSavedSemanticViewerChartResults = async ({
    ...
    const scheduledJob = await bigbytesApi<ApiJobScheduledResponse['results']>(
        {
            version: 'v2',
...
export const apiPatchSavedSemanticViewerChart = ({
    ...
    bigbytesApi<ApiSemanticViewerChartUpdate['results']>({
        version: 'v2',
