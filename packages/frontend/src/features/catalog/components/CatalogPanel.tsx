                ...
                >
                    {noTables ? (
                        <SuboptimalState
                            ...
                            description={
                                "Tables are the starting point to any data exploration in Clairdash. They come from dbt models that have been defined in your dbt project's .yml files."
                            }
                            action={
                                <LinkButton
                                    href="https://docs.clairdash.com/guides/adding-tables-to-clairdash"
                                    mt="md"
                                    target="_blank"
                                    sx={(theme) => ({
