                ...
                >
                    {noTables ? (
                        <SuboptimalState
                            ...
                            description={
                                "Tables are the starting point to any data exploration in Bigbytes. They come from dbt models that have been defined in your dbt project's .yml files."
                            }
                            action={
                                <LinkButton
                                    href="https://docs.bigbytes.com/guides/adding-tables-to-bigbytes"
                                    mt="md"
                                    target="_blank"
                                    sx={(theme) => ({
