...
const createTag = async (
    ...
    return bigbytesApi<ApiCreateTagResponse['results']>({
...
const getTags = async (projectUuid: string) => {
    return bigbytesApi<ApiGetTagsResponse['results']>({
        url: `/projects/${projectUuid}/tags`,
        method: 'GET',
        body: undefined,
    });
...
const updateTag = async (
    ...
    return bigbytesApi<ApiSuccessEmpty['results']>({
...
const deleteTag = async (projectUuid: string, tagUuid: string) => {
    return bigbytesApi<ApiSuccessEmpty>({
        url: `/projects/${projectUuid}/tags/${tagUuid}`,
        method: 'DELETE',
        body: undefined,
    });
