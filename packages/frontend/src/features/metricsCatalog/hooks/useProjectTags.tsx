...
const createTag = async (
    ...
    return clairdashApi<ApiCreateTagResponse['results']>({
...
const getTags = async (projectUuid: string) => {
    return clairdashApi<ApiGetTagsResponse['results']>({
        url: `/projects/${projectUuid}/tags`,
        method: 'GET',
        body: undefined,
    });
...
const updateTag = async (
    ...
    return clairdashApi<ApiSuccessEmpty['results']>({
...
const deleteTag = async (projectUuid: string, tagUuid: string) => {
    return clairdashApi<ApiSuccessEmpty>({
        url: `/projects/${projectUuid}/tags/${tagUuid}`,
        method: 'DELETE',
        body: undefined,
    });
