import { type ItemsMap } from '@clairdash/common';
                ...
                isThresholdAlert ? (
                    <Group spacing="xs">
                        ...
                        <DocumentationHelpButton
                            href="https://docs.clairdash.com/guides/how-to-create-alerts"
                            pos="relative"
                            top="2px"
                        />
                    </Group>
                    ...
                    <Group spacing="xs">
                        ...
                        <DocumentationHelpButton
                            href="https://docs.clairdash.com/guides/how-to-create-scheduled-deliveries"
                            pos="relative"
                            top="2px"
                        />
                    </Group>
