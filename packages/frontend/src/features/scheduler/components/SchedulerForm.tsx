        ...
        return (
            <>
                ...
                <Text>
                    ...
                    <Anchor
                        target="_blank"
                        href="https://docs.clairdash.com/self-host/customize-deployment/configure-a-slack-app-for-clairdash"
                    >
                        {' '}
                        setup Slack{' '}
                    </Anchor>
                    for your Clairdash instance
                </Text>
            </>
        );
            ...
            <Tabs defaultValue="setup">
                        ...
                        >
                            {isThresholdAlert && (
                                <Tooltip
                                    ...
                                    maw={400}
                                    multiline
                                    label=" This is the frequency at which Clairdash runs a query to check your data for changes. (You will be notified if the conditions on the latest value are met) "
                                    position="top"
                                >
                                    <MantineIcon
                                        icon={IconHelpCircle}
                            ...
                            <Stack spacing={0}>
                                ...
                                <Group spacing="xs" noWrap>
                                    ...
                                    {isImageDisabled && (
                                        ...
                                        >
                                            You must enable the
                                            <Anchor href="https://docs.clairdash.com/self-host/customize-deployment/enable-headless-browser-for-clairdash">
                                                {' '}
                                                headless browser{' '}
                                            </Anchor>
                                            to send images
                                        ...
                                        <HoverCard.Dropdown>
                                            <>
                                                ...
                                                <Text>
                                                    ...
                                                    <Anchor
                                                        target="_blank"
                                                        href="https://docs.clairdash.com/references/environmentVariables"
                                                    >
                                                        {' '}
                                                        SMTP environment
                                                        variables{' '}
                                ...
                                <Stack spacing="xs" mb="sm">
                                    ...
                                    {!isAddSlackDisabled && (
                                        <Text size="xs" color="gray.6" ml="3xl">
                                            ...
                                            invite the Clairdash Slackbot into
                                            that channel.
                                        </Text>
                                    )}
                                </Stack>
                ...
                <Tabs.Panel value="customization">
                    <Stack p="md">
                        <Group>
                            <Switch
                                label="Include links to Clairdash"
                            ...
                            ></Switch>
                            <Tooltip
                                label={`Include links to the shared content in your Clairdash project. \n
                                                                 We recommend turning this off if you're sharing with users who do not have access to your Clairdash project`}
                                multiline
                                withinPortal
                                position="right"
                                maw={400}
