import { DbtProjectType, snakeCaseName } from '@clairdash/common';
import {
    Button,
    Group,
    Modal,
            ...
            title={
                <Group spacing="xs">
                    ...
                    <Tooltip
                        ...
                        multiline
                        maw={300}
                        label={`Create a virtual view so others can reuse this query in Clairdash. The query won’t be saved to or managed in your dbt project. ${
