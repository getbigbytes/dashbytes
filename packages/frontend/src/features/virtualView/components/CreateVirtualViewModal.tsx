import { DbtProjectType, snakeCaseName } from '@bigbytes/common';
import {
    Button,
    Group,
    Modal,
            ...
            title={
                <Group spacing="xs">
                    ...
                    <Tooltip
                        ...
                        multiline
                        maw={300}
                        label={`Create a virtual view so others can reuse this query in Bigbytes. The query won’t be saved to or managed in your dbt project. ${
