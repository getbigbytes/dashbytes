...
import ClairdashLogo from '../svgs/clairdash-black.svg';
            ...
            >
                <Stack spacing="md" align="center">
                    ...
                    <Text color="gray.6" ta="center">
                        ...
                        } are using Clairdash to discover
                ...
                {inviteLinkQuery.error ? (
                    ...
                    <>
                        ...
                        <Text color="gray.6" ta="center">
                            ...
                            our{' '}
                            <Anchor
                                href="https://www.clairdash.com/privacy-policy"
                                target="_blank"
                            >
                                Privacy Policy
                            </Anchor>{' '}
                            and our{' '}
                            <Anchor
                                href="https://www.clairdash.com/terms-of-service"
                                target="_blank"
                            >
                                Terms of Service.
                            </Anchor>
