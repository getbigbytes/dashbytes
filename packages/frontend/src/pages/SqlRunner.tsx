...
import BigbytesVisualization from '../components/BigbytesVisualization';
import VisualizationProvider from '../components/BigbytesVisualization/VisualizationProvider';
        ...
        >
            ...
            <Stack mt="lg" spacing="sm" sx={{ flexGrow: 1 }}>
                ...
                >
                    ...
                    >
                        <BigbytesVisualization className="sentry-block ph-no-capture" />
                    </CollapsableCard>
                </VisualizationProvider>
