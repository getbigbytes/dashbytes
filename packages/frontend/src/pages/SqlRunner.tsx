...
import ClairdashVisualization from '../components/ClairdashVisualization';
import VisualizationProvider from '../components/ClairdashVisualization/VisualizationProvider';
        ...
        >
            ...
            <Stack mt="lg" spacing="sm" sx={{ flexGrow: 1 }}>
                ...
                >
                    ...
                    >
                        <ClairdashVisualization className="sentry-block ph-no-capture" />
                    </CollapsableCard>
                </VisualizationProvider>
