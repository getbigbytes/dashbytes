...
import { WarehouseClient, WarehouseTableSchema } from '@clairdash/warehouses';
...
export const getModelsFromManifest = (
    ...
    if (!isSupportedDbtAdapter(manifest.metadata)) {
        throw new ParseError(
            `dbt adapter not supported. Clairdash does not support adapter ${manifest.metadata.adapter_type}`,
            {},
        );
    }
