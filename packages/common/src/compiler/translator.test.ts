...
import {
    ...
    CLAIRDASH_TABLE_SQL_WHERE,
    CLAIRDASH_TABLE_WITHOUT_AUTO_METRICS,
    CLAIRDASH_TABLE_WITH_ADDITIONAL_DIMENSIONS,
    CLAIRDASH_TABLE_WITH_CUSTOM_TIME_INTERVAL_DIMENSIONS,
    CLAIRDASH_TABLE_WITH_DBT_METRICS,
    CLAIRDASH_TABLE_WITH_DBT_V9_METRICS,
    CLAIRDASH_TABLE_WITH_DEFAULT_TIME_INTERVAL_DIMENSIONS_BIGQUERY,
    CLAIRDASH_TABLE_WITH_DEFAULT_TIME_INTERVAL_DIMENSIONS_SNOWFLAKE,
    CLAIRDASH_TABLE_WITH_GROUP_BLOCK,
    CLAIRDASH_TABLE_WITH_GROUP_LABEL,
    CLAIRDASH_TABLE_WITH_METRICS,
    CLAIRDASH_TABLE_WITH_OFF_TIME_INTERVAL_DIMENSIONS,
    model,
...
describe('convert tables from dbt models', () => {
    it('should convert dbt model without metrics to Clairdash table without autogenerated metrics', () => {
        expect(
            convertTable(
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITHOUT_AUTO_METRICS);
    });
    it('should convert dbt model with dbt metrics', () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_DBT_METRICS);
        // dbt 1.5 metrics
        expect(
            convertTable(SupportedDbtAdapter.BIGQUERY, MODEL_WITH_NO_METRICS, [
                DBT_V9_METRIC,
            ]),
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_DBT_V9_METRICS);
    });
    it('should convert dbt model with metrics in meta', () => {
        expect(
            convertTable(SupportedDbtAdapter.BIGQUERY, MODEL_WITH_METRIC, []),
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_METRICS);
    });
    ...
    it('should convert dbt model with dimension with off time intervals', () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_OFF_TIME_INTERVAL_DIMENSIONS);
    });
    ...
    it('should convert dbt model with dimension with custom time intervals', () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_CUSTOM_TIME_INTERVAL_DIMENSIONS);
    });
    ...
    it('should convert dbt model with group label', async () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_GROUP_LABEL);
    });
    ...
    it('should convert dbt model with sql where', async () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_SQL_WHERE);
    });
    ...
    it('should convert dbt model with dimension and additional dimensions', () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_ADDITIONAL_DIMENSIONS);
    });
    ...
    it('should convert dbt model with groups meta block', async () => {
        ...
        ).toStrictEqual(CLAIRDASH_TABLE_WITH_GROUP_BLOCK);
    });
});
