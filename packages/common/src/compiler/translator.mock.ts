...
export const BASE_BIGBYTES_TABLE: Omit<Table, 'lineageGraph'> = {
    name: model.name,
    label: 'My table',
...
export const BIGBYTES_TABLE_WITH_GROUP_LABEL: Omit<Table, 'lineageGraph'> = {
    ...BASE_BIGBYTES_TABLE,
    groupLabel: 'revenue',
};

export const BIGBYTES_TABLE_WITH_GROUP_BLOCK: Omit<Table, 'lineageGraph'> = {
    ...BASE_BIGBYTES_TABLE,
    dimensions: {
        user_id: {
            compact: undefined,
...
export const BIGBYTES_TABLE_WITHOUT_AUTO_METRICS: Omit<Table, 'lineageGraph'> =
    {
        ...BASE_BIGBYTES_TABLE,
        dimensions: {
            user_id: {
...
export const BIGBYTES_TABLE_WITH_DBT_METRICS: Omit<Table, 'lineageGraph'> = {
...
export const BIGBYTES_TABLE_WITH_DBT_V9_METRICS: Omit<Table, 'lineageGraph'> =
    {
        ...BIGBYTES_TABLE_WITHOUT_AUTO_METRICS,
        metrics: {
            dbt_metric_1: {
...
export const BIGBYTES_TABLE_WITH_METRICS: Omit<Table, 'lineageGraph'> = {
    ...BASE_BIGBYTES_TABLE,
...
export const BIGBYTES_TABLE_WITH_DEFAULT_TIME_INTERVAL_DIMENSIONS_BIGQUERY: Omit<
    Table,
    'lineageGraph'
> = {
    ...BASE_BIGBYTES_TABLE,
...
export const BIGBYTES_TABLE_WITH_DEFAULT_TIME_INTERVAL_DIMENSIONS_SNOWFLAKE: Omit<
    Table,
    'lineageGraph'
> = {
    ...BASE_BIGBYTES_TABLE,
...
export const BIGBYTES_TABLE_WITH_OFF_TIME_INTERVAL_DIMENSIONS: Omit<
    Table,
    'lineageGraph'
> = {
    ...BASE_BIGBYTES_TABLE,
...
export const BIGBYTES_TABLE_WITH_CUSTOM_TIME_INTERVAL_DIMENSIONS: Omit<
    Table,
    'lineageGraph'
> = {
    ...BASE_BIGBYTES_TABLE,
...
export const BIGBYTES_TABLE_SQL_WHERE: Omit<Table, 'lineageGraph'> = {
    ...BASE_BIGBYTES_TABLE,
...
export const BIGBYTES_TABLE_WITH_ADDITIONAL_DIMENSIONS: Omit<
    Table,
    'lineageGraph'
> = {
    ...BASE_BIGBYTES_TABLE,
    dimensions: {
        metadata: {
            ...
            name: 'metadata',
            label: 'Metadata',
            table: BASE_BIGBYTES_TABLE.name,
            tableLabel: 'My table',
            source: undefined,
            timeInterval: undefined,
            timeIntervalBaseDimensionName: undefined,
