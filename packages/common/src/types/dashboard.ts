...
export type DashboardChartTileProperties = {
    ...
    properties: {
        ...
        belongsToDashboard?: boolean; // this should be required and not part of the "create" types, but we need to fix tech debt first. Open ticket https://github.com/getbigbytes/bigbytes/issues/6450
