...
type DbtClairdashFieldTags = {
    tags?: string | string[];
};

type DbtModelMetadata = DbtModelClairdashConfig & {};

type DbtModelClairdashConfig = {
    label?: string;
    joins?: DbtModelJoin[];
    metrics?: Record<string, DbtModelClairdashMetric>;
...
type DbtColumnMetadata = DbtColumnClairdashConfig & {};
type DbtColumnClairdashConfig = {
    dimension?: DbtColumnClairdashDimension;
    additional_dimensions?: {
        [subDimensionName: string]: DbtColumnClairdashAdditionalDimension;
    };
    metrics?: { [metricName: string]: DbtColumnClairdashMetric };
};

export type DbtColumnClairdashDimension = {
    name?: string;
    label?: string;
    type?: DimensionType;
    description?: string;
    ...
    urls?: FieldUrl[];
    required_attributes?: Record<string, string | string[]>;
} & DbtClairdashFieldTags;

type DbtColumnClairdashAdditionalDimension = Omit<
    DbtColumnClairdashDimension,
    'name'
>;

export type DbtColumnClairdashMetric = {
    label?: string;
    type: MetricType;
    description?: string;
    sql?: string;
...
export type DbtModelClairdashMetric = DbtColumnClairdashMetric &
    Required<Pick<DbtColumnClairdashMetric, 'sql'>>;
...
export type DbtMetric = Omit<ParsedMetric, 'refs'> & {
    meta?: Record<string, any> & DbtMetricClairdashMetadata;
    refs?: string[][] | V9MetricRef[];
};

export type DbtMetricClairdashMetadata = {
    hidden?: boolean;
    group_label?: string;
    groups?: string[];
    show_underlying_values?: string[];
...
type ConvertModelMetricArgs = {
    modelName: string;
    name: string;
    metric: DbtModelClairdashMetric;
    source?: Source;
    tableLabel: string;
...
type ConvertColumnMetricArgs = Omit<ConvertModelMetricArgs, 'metric'> & {
    metric: DbtColumnClairdashMetric;
