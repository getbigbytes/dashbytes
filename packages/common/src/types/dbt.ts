...
type DbtBigbytesFieldTags = {
    tags?: string | string[];
};

type DbtModelMetadata = DbtModelBigbytesConfig & {};

type DbtModelBigbytesConfig = {
    label?: string;
    joins?: DbtModelJoin[];
    metrics?: Record<string, DbtModelBigbytesMetric>;
...
type DbtColumnMetadata = DbtColumnBigbytesConfig & {};
type DbtColumnBigbytesConfig = {
    dimension?: DbtColumnBigbytesDimension;
    additional_dimensions?: {
        [subDimensionName: string]: DbtColumnBigbytesAdditionalDimension;
    };
    metrics?: { [metricName: string]: DbtColumnBigbytesMetric };
};

export type DbtColumnBigbytesDimension = {
    name?: string;
    label?: string;
    type?: DimensionType;
    description?: string;
    ...
    urls?: FieldUrl[];
    required_attributes?: Record<string, string | string[]>;
} & DbtBigbytesFieldTags;

type DbtColumnBigbytesAdditionalDimension = Omit<
    DbtColumnBigbytesDimension,
    'name'
>;

export type DbtColumnBigbytesMetric = {
    label?: string;
    type: MetricType;
    description?: string;
    sql?: string;
...
export type DbtModelBigbytesMetric = DbtColumnBigbytesMetric &
    Required<Pick<DbtColumnBigbytesMetric, 'sql'>>;
...
export type DbtMetric = Omit<ParsedMetric, 'refs'> & {
    meta?: Record<string, any> & DbtMetricBigbytesMetadata;
    refs?: string[][] | V9MetricRef[];
};

export type DbtMetricBigbytesMetadata = {
    hidden?: boolean;
    group_label?: string;
    groups?: string[];
    show_underlying_values?: string[];
...
type ConvertColumnMetricArgs = Omit<ConvertModelMetricArgs, 'metric'> & {
    metric: DbtColumnBigbytesMetric;
