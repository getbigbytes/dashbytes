...
export { default as bigbytesDbtYamlSchema } from './schemas/json/bigbytes-dbt-2.0.json';
...
export const isBigbytesMode = (x: string): x is BigbytesMode =>
    Object.values<string>(BigbytesMode).includes(x);

export enum BigbytesInstallType {
