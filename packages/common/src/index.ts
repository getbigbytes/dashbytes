...
export { default as clairdashDbtYamlSchema } from './schemas/json/clairdash-dbt-2.0.json';
...
export const isClairdashMode = (x: string): x is ClairdashMode =>
    Object.values<string>(ClairdashMode).includes(x);

export enum ClairdashInstallType {
