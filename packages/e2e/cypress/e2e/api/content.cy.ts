import { SEED_PROJECT } from '@bigbytes/common';
import { chartMock } from '../../support/mocks';

const apiUrl = '/api/v2';

describe('Bigbytes catalog all tables and fields', () => {
    let content: any[] = [];
    beforeEach(() => {
        cy.login();
    });

    // original API implementation and samples https://github.com/getbigbytes/bigbytes/pull/10741
