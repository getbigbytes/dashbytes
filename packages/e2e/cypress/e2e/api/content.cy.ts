import { SEED_PROJECT } from '@clairdash/common';
import { chartMock } from '../../support/mocks';

const apiUrl = '/api/v2';

describe('Clairdash catalog all tables and fields', () => {
    let content: any[] = [];
    beforeEach(() => {
        cy.login();
    });

    // original API implementation and samples https://github.com/clairview/clairdash/pull/10741
