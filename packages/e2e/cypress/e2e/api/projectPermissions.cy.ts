...
describe('Clairdash API tests for member user with admin project permissions', () => {
    let email;
    before(() => {
...
describe('Clairdash API tests for member user with editor project permissions', () => {
    let email;
...
describe('Clairdash API tests for member user with developer project permissions', () => {
    let email;
...
describe('Clairdash API tests for member user with interactive_viewer project permissions', () => {
    let email;
...
describe('Clairdash API tests for member user with viewer project permissions', () => {
    let email;
...
describe('Clairdash API tests for member user with NO project permissions', () => {
    let email;
...
describe('Clairdash API tests for project members access', () => {
    beforeEach(() => {
        cy.login();
    });
