import { Dashboard, SavedChart, SEED_PROJECT, Space } from '@bigbytes/common';
...
describe('Bigbytes API tests for my own private spaces as admin', () => {
    beforeEach(() => {
        cy.login();
    });
...
describe('Bigbytes API tests for an editor accessing other private spaces', () => {
...
describe('Bigbytes API tests for an project admin accessing other private spaces', () => {
    let privateChart: SavedChart;
    let privateSpaceChart: Space;
    let privateSpaceDashboard: Space;
