import { MetricQuery, SEED_PROJECT } from '@clairdash/common';
...
describe('Clairdash API organization permission tests', () => {
    beforeEach(() => {
        cy.anotherLogin();
    });
...
describe('Clairdash API tests for organization on different roles', () => {
    [
        'admin',
        'developer',
        'editor',
...
describe('clairdash API tests for project creation permissions', () => {
    [
        {
            role: 'admin',
