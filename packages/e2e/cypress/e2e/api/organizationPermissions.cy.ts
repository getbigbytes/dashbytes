import { MetricQuery, SEED_PROJECT } from '@bigbytes/common';
...
describe('Bigbytes API organization permission tests', () => {
    beforeEach(() => {
        cy.anotherLogin();
    });
...
describe('Bigbytes API tests for organization on different roles', () => {
    [
        'admin',
        'developer',
        'editor',
...
describe('bigbytes API tests for project creation permissions', () => {
    [
        {
            role: 'admin',
