...
to <support@getbigbytes.com>.

## How to ask for help

Useful resources for answering your questions:

-   [Documentation](https://bigbytesdocs.getbigbytes.com)
...
> Vulnerabilities can be submitted through the GitHub repository security tab or by email at <security@getbigbytes.com>.
...
you can find more about headless browser on [our docs](https://bigbytesdocs.getbigbytes.com/self-host/customize-deployment/enable-headless-browser-for-bigbytes).
