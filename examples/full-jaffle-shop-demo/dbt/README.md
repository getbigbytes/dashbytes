## How to use this project in Clairdash 

### Install Clairdash:
Take advantage of our installation script to easily run Clairdash locally. Check the [documentation page](https://docs.clairdash.com/get-started/setup-clairdash/install-clairdash#deploy-locally-with-our-installation-script) for more details.
```bash
...
- type: github
- personal access token: (follow the [docs instructions](https://docs.clairdash.com/get-started/setup-clairdash/connect-project/#personal-access-token) to get one) 
- repository: clairdash/jaffle_shop
- branch: main
