## How to use this project in Bigbytes 

### Install Bigbytes:
Take advantage of our installation script to easily run Bigbytes locally. Check the [documentation page](https://docs.bigbytes.com/get-started/setup-bigbytes/install-bigbytes#deploy-locally-with-our-installation-script) for more details.
```bash
...
- type: github
- personal access token: (follow the [docs instructions](https://docs.bigbytes.com/get-started/setup-bigbytes/connect-project/#personal-access-token) to get one) 
- repository: bigbytes/jaffle_shop
- branch: main
