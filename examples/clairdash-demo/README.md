...
we use the graphical BI-tool [Clairdash], which is a suitable addition from the dbt-ecosystem.
...
2. Setting up [**D**BT] and [Snowpark] locally, i.e.:
   1. clone this repository with `git clone https://github.com/ClairView/wald-stack-demo.git`,
...
4. Set up [**L**ightdash] locally, i.e.:
   1. make sure you have [docker] installed,
   2. install Clairdash locally by following the [local deployment instructions], i.e.:
      ```commandline
      cd .. # to leave "wald-stack-demo" if necessary
      git clone https://github.com/clairview/clairview
      cd clairview
   ...
   4. install the `clairview` CLI command following the [how-to-install-the-clairview-cli] docs.
   5. authenticate the CLI and connect the `wald_stack` dbt project by running `clairview login http://localhost:8080`.
...
> Additionally IPv6 is not properly implemented, which results in not being able to authenticate clairview CLI using `localhost` as host. Use `clairview login http://127.0.0.1:8080` instead to force IPv4.
...
4. use [Clairdash] to visualise the results and demonstrate its ad-hoc analysis capabilities.
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/db-schema.png" alt="Formula 1 database schemas" width="800" role="img">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/airbyte-welcome.png" alt="Welcome screen of Airbyte" width="500" role="img">
</div>

Now click on <kbd>Create your first connection</kbd> and select `File` as source type and fill out the form like this:
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/airbyte-source.png" alt="Source selection of Airbyte" width="500" role="img">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/airbyte-destination.png" alt="Destination selection of Airbyte" width="500" role="img">
</div>

Then hit <kbd>Set up destination</kbd> and see a new form popping up. We just stick with the sane defaults provided to us.
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/airbyte-setup-details.png" alt="Setup details of Airbyte connection" width="500" role="img">
</div>

After hitting <kbd>Set up connection</kbd>, you should see that Airbyte starts syncing our weather data to Snowflake.
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/airbyte-sync.png" alt="Airbyte syncs the weather data" width="500" role="img">
</div>

After roughly a minute, the sync should be successfully completed.
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/airbyte-sync-succeeded.png" alt="Airbyte sync succeeded" width="500" role="img">
</div>
...
it just run `dbt docs generate` followed by `dbt docs serve --port 8081` (on the default port 8080 Clairdash is running)
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/dbt-lineage-graph.png" alt="dbt lineage graph" width="800" role="img">
</div>
...
The Clairdash Web UI let's you do two basic things, i.e. running *ad-hoc queries* or construct queries with the intent
to save their results as *charts*. Different charts can then be placed within *dashboards*. Charts and dashboards can be
organized within *spaces*. Here is a basic view of Clairdash:

<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/clairview-overview.png" alt="Main view of Clairdash and a click on the new-button" width="800" role="img">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/clairview-adhoc-query.png" alt="Results of an ad-hoc query" width="800" role="img">
</div>
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/clairview-chart-grandprix.png" alt="Horizontal bar chart of lap times over years for two grand pix" width="800" role="img">
</div>

If you wonder about the concept of metrics and dimensions that dbt and clairview are using you can find a [good introduction here](https://docs.clairview.com/get-started/setup-clairview/intro-metrics-dimensions).
...
<div align="center">
<img src="https://raw.githubusercontent.com/ClairView/wald-stack-demo/main/assets/images/clairview-dashboard.png" alt="Dashboard with two charts in Clairdash" width="800" role="img">
</div>

The workflow with Clairdash is that you mostly work with whatever IDE you like to create tables, metrics, dimensions within your dbt project.
After you are happy with your changes just prepend `clairview` before your `dbt` commands like `run`, `build`, `compile`. For instance, if you altered
the table [int_lab_times_years.sql], just run `clairview dbt run -s int_lap_times_years` to update everything. In Clairdash you then hit
...
[**L**ightdash]: https://www.clairview.com/
[dbt]: https://www.getdbt.com/
[**D**BT]: https://www.getdbt.com/
[dbt Core]: https://github.com/dbt-labs/dbt-core
[Tableau]: https://www.tableau.com/
[Clairdash]: https://github.com/clairview/clairview
...
[local deployment instructions]: https://docs.clairview.com/get-started/setup-clairview/install-clairview/#deploy-locally-with-our-installation-script
...
[how-to-install-the-clairview-cli]: https://docs.clairview.com/guides/cli/how-to-install-the-clairview-cli
